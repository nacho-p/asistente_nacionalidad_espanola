...
const DECISION_TREE: DecisionTree = {
  ...
  ud_nacio_1960: {
    ...
    options: {
      no: { label: 'No', result: 'NACIONALIDAD_ORIGEN' },
  ...
  adquirio_1978: {
    question: '¿La adquisición de la nacionalidad argentina fue antes del 29/12/1978?',
    options: {
      no: { label: 'No', nextStepId: 'ud_nacio_1960' },
  ...
  ud_nacio_1985: {
    ...
    options: {
      ...
      si: { label: 'Sí', result: 'NACIONALIDAD_ORIGEN' },
    },
  },
  ud_tiene_20_o_menos: {
  ...
  madre_adquirio_1978_a: {
    question:
      '¿La adquisición de la nacionalidad argentina fue antes del 29/12/1978?',
    options: {
      no: { label: 'No', nextStepId: 'ud_nacio_1978_a' },
      si: { label: 'Sí', result: 'OPCION' },
    },
  ...
  es_su_padre: {
    question: '¿Se trata de su padre o de su madre?',
    options: {
      madre: { label: 'Madre', nextStepId: 'ud_tiene_18_o_menos_c' },
      padre: { label: 'Padre', nextStepId: 'padre_hizo_servicio_militar' },
    },
  },
